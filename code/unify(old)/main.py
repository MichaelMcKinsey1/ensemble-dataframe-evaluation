...
gf2 = ht.GraphFrame.from_caliper_json(dataset)
gf2.dataframe.reset_index("rank", drop=True, inplace=True)
print(gf2.dataframe.index.names)
display(gf2.dataframe)
...
for i in range(num_datasets): # https://github.com/TauferLab/llnl-hatchet/blob/bd7d4c96c7a20d7a7b05cf1a4f41846ae36ab980/hatchet/tests/graphframe.py#L1186-L1192
    ...
    gf.dataframe.reset_index("rank", drop=True, inplace=True)
